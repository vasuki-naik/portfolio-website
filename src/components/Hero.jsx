  ...
  return (
    <section ref={ref} className="relative min-h-screen flex items-center pt-20 pb-20 overflow-hidden">
      <motion.div style={{ opacity }} className="max-w-5xl mx-auto px-6 w-full">
        <div className="grid md:grid-cols-[auto_1fr] gap-16 md:gap-24 items-center">
          ...
          >
            <div className="relative">
              {/* Ambient glow — large */}
              <div className="absolute -inset-10 rounded-full animate-pulse-soft"
                style={{
              ...
              />
              {/* Photo */}
              <div className="relative w-[230px] h-[230px] md:w-[270px] md:h-[270px] rounded-full overflow-hidden bg-[#EAF2EC]"
                style={{ boxShadow: '0 8px 48px rgba(95,143,120,0.22), 0 2px 12px rgba(24,38,30,0.08)' }}
              >
                <img src="/vasuki.jpg" alt="Vasuki Nagesh Naik"
              ...
              >
                <motion.div animate={{ scale: [1, 1.5, 1], opacity: [1, 0.7, 1] }}
                  transition={{ repeat: Infinity, duration: 2.4, ease: 'easeInOut' }}
                  className="w-2 h-2 rounded-full bg-emerald-400"
                />
                <span className="text-[11px] font-semibold text-[#2D4035] tracking-wide">Open to Internships</span>
              </motion.div>
            </div>
          </motion.div>
          ...
          >
            ...
            <motion.h1 variants={stagger.item} className="hero-title">
              ...
              <br />
              <span style={{ color: '#B8C8BF', fontWeight: 300 }}>Naik</span>
            </motion.h1>

            <motion.div variants={stagger.item} className="space-y-2">
              <p style={{ color: '#526359', fontSize: '1rem', fontWeight: 400 }}>
                Data Analyst <span style={{ color: '#C8DAD1', margin: '0 10px' }}>·</span> Machine Learning Enthusiast
              </p>
              <div className="flex items-center gap-1.5" style={{ color: '#8A9E94', fontSize: '0.85rem' }}>
            ...
            <motion.p variants={stagger.item}
              style={{
                color: '#526359', fontSize: '0.9rem', lineHeight: 1.8, maxWidth: '420px',
                paddingLeft: '16px', borderLeft: '2px solid #C0D9CA', fontStyle: 'italic',
              }}
            >
        ...
        >
          <span style={{ fontSize: '0.6rem', letterSpacing: '0.2em', color: '#B8C8BF', fontWeight: 600, textTransform: 'uppercase' }}>scroll</span>
          <motion.div
